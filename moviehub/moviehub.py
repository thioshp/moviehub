...
def main():
	...
	PROGRAM_NAME = 'MOVIE HUB'
	PROGRAM_VERSION = '1.0.1'
	PROGRAM_WEBSITE = 'www.github.com/chunkhang/moviehub'
	AUTHOR_NAME = 'MARCUS MU'
	AUTHOR_EMAIL = 'chunkhang@gmail.com'
	AUTHOR_WEBSITE = 'www.marcusmu.me'
	...
	print(centerAlign('Version %s' % PROGRAM_VERSION, PROGRAM_WIDTH))
	...
	while True:
		...
		if choice == 0 or choice == 1:
			...
			print()
			printHeader('About')
			print(centerAlign(AUTHOR_NAME, PROGRAM_WIDTH))
			print(centerAlign('develops Movie Hub', PROGRAM_WIDTH))
			print(centerAlign('~ %s ~' % AUTHOR_WEBSITE, PROGRAM_WIDTH))
			print()
			print(centerAlign('OMDb API', PROGRAM_WIDTH))
			print(centerAlign('powers Movie Hub', PROGRAM_WIDTH))
			print(centerAlign('~ %s ~' % API_URL[7:-1], PROGRAM_WIDTH))
			print()
			print(centerAlign(PROGRAM_NAME, PROGRAM_WIDTH))
			print(centerAlign('is made for movie lovers', PROGRAM_WIDTH))
			print(centerAlign('~ %s ~' % PROGRAM_WEBSITE, PROGRAM_WIDTH))
			printDivider(PROGRAM_WIDTH)
			continue
		else:
			exit(0)
